    ...
    <>
      ...
      <div className="container-fluid">
        <div className="row m-0 p-0">
          <div className="col-6 m-0 p-4">
            ...
            <ul>
              <li>
                Academicians and Industry Persons - ₹3500 (Indian Authors) / $60
          ...
          <div className="col-6 m-0 p-4">
            ...
            <ul>
              ...
              <li>
                ...
                recommended for Springer CCIS (Scopus Indexed) / Mapana Journal
                of science (UGC care list - Group I) / proceeding with ISBN
                number
              </li>
            </ul>
          </div>
      ...
      <div className="row m-0 mt-5 p-0 align-items-center ">
        <div className="col-md-12 col-12 m-0 p-0">
          <div className="row m-0 p-0">
            <div
              className="col-md-12 col-12 m-0 p-4  h-100 justify-content-center align-items-center text-center"
              id="subscribe"
            >
              <h3 className="justify-content-center align-items-center text-center">
                {" "}
              ...
              <p style={{ fontFamily: "Nunito" }}>
                ...
                conference paper templates, which can be find in the below
                button
              </p>
              <button
      ...
      <div className="row m-0 mt-5 p-0 align-items-center ">
        <div className="col-md-12 col-12 m-0 p-0">
          <div className="row m-0 p-0">
            <div className="col-md-6 col-12 m-0 p-4 h-100"></div>
            ...
            >
              <h3 className="justify-content-center align-items-center text-center">
                ICCSST 2025 Attendee Registration form
              </h3>
              <div class="row  g-3  justify-content-center text-center mt-4">
                <p>
                  Kindly click the below button to participate as an attendee in
                  the conference
                </p>
                <div class="col-12">
                  <button type="submit" class="btn btn-primary">
                    <a
                      ...
                      href="https://forms.gle/2mDnJxcacvLLPXne9"
                    >
                      Click Here
                    </a>
                  </button>
